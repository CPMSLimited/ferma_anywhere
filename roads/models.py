...
class Route(models.Model):
    ...
    route_index = models.CharField(max_length=2, unique=True)
...
class Address(models.Model):
    ...
    def __str__(self):
        return self.name or self.address or "Unnamed Address"

class Segment(models.Model):
    route = models.ForeignKey(Route, db_column='route_index', on_delete=models.PROTECT, default=1)
